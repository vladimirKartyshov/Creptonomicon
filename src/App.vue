  ...
  <div class="container mx-auto flex flex-col items-center bg-gray-100 p-4">
    <div class="container">
      ...
      <section>
        <div class="flex">
          <div class="max-w-xs">
            ...
            <div class="mt-1 relative rounded-md shadow-md">
              <input v-model="ticker" @keydown.enter="add" type="text" name="wallet" id="wallet" class="
                  block
                  w-full
                  pr-10
                  border-gray-300
        ...
        <button @click="add" type="button" class="
            my-4
            inline-flex
            items-center
            py-2
      ...
      <template v-if="tickers.length">
        ...
        <div>
          ...
          <div>
            Фильтр:
            <input class="pl-2" v-model="filter" placeholder="Введите крипту" />
          </div>
        </div>
        <hr class="w-full border-t border-gray-600 my-4" />
        <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
          <div v-for="t in paginatedTickers" :key="t.name" @click="select(t)" :class="{
            ...
            <button @click.stop="handleDelete(t)" class="
                flex
                items-center
                justify-center
                font-medium
